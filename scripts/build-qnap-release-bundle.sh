...
test -f "$BUNDLE/cos-mcp/qnap-security-review-v4.1.10.md"
test -f "$BUNDLE/cos-mcp/release-4.1.10-scheduled-slack-hitl.md"
test -f "$BUNDLE/cos-mcp/chatgpt-published-app-production-acceptance-v4.1.10.md"
test -f "$BUNDLE/cos-mcp/scheduled-automation-slack-hitl-v4.1.10.feature"
