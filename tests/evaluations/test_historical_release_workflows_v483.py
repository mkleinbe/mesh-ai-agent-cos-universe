...
def test_v4121_is_the_only_semver_release_publisher() -> None:
    current = _active_yaml_text((WORKFLOWS / "release-v4.12.1.yml").read_text(encoding="utf-8"))
