...
**Role:** Delivery feasibility, capacity, and resource-readiness executive.

## Phase 1 accountability

- Determine whether proposed work can be delivered with available capacity, dependencies, and approved resources.
- Own delivery configuration, POD/resource composition, capacity analysis, dependency readiness, partner capacity, and operational constraints.
- Sense delivery and staffing risks early and provide evidence-backed staffing recommendations.
