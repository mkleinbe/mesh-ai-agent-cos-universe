...
ENV NODE_ENV=production PYTHONPATH=/opt/mesh/src PYTHONDONTWRITEBYTECODE=1 MESH_COS_PYTHON_BIN=python3 MCP_BIND_HOST=0.0.0.0 MCP_PORT=8080 HOME=/tmp MESH_COS_SOURCE_COMMIT=${VCS_REF}
USER 65532:65532
EXPOSE 8080
