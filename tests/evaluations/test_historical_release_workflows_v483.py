...
HISTORICAL = (
    ...
    "4.4.1", "4.4.2",
    "4.5.0", "4.5.1", "4.5.2",
    "4.6.0", "4.7.0", "4.8.0", "4.8.1", "4.8.2", "4.8.3", "4.8.4", "4.9.0",
)
...
def test_all_published_historical_release_workflows_are_read_only_manual_verifiers() -> None:
    for version in HISTORICAL:
        raw = (WORKFLOWS / f"release-v{version}.yml").read_text(encoding="utf-8")
...
def test_v491_is_the_only_semver_release_publisher() -> None:
    current = _active_yaml_text((WORKFLOWS / "release-v4.9.1.yml").read_text(encoding="utf-8"))
