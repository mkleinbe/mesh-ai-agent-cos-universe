...
def test_historical_release_evidence_remains_with_v440_production_deployment() -> None:
    ...
    assert "earlier evidence remain preserved for audit and regression continuity" in readme
