...
def test_historical_release_evidence_remains_while_v470_is_current_and_v441_is_candidate() -> None:
    ...
    assert "QNAP deployment candidate is now a distinct `4.4.1` artifact" in readme
