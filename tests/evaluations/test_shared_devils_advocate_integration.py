...
def test_qnap_release_preserves_v4_authority_contract() -> None:
    ...
    assert "# v4.7.0 Enterprise Consulting Skill Consumption" in release_notes
    assert "# v4.4.0 Authority Closure" in release_notes
    assert "canonical Phase 1 authority/runtime contract **4.0.0**" in release_notes
    assert "production QNAP **4.4.0**" in release_notes
