...
HISTORICAL = (
    ...
    "4.10.0", "4.11.0", "4.11.1", "4.12.0", "4.12.1", "4.13.0", "4.13.1", "4.13.2",
)
...
def test_v4133_is_the_only_semver_release_publisher() -> None:
    current = _active_yaml_text((WORKFLOWS / "release-v4.13.3.yml").read_text(encoding="utf-8"))
